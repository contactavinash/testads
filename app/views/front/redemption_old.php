...
<section class="inner-page-sec gap-top-20  clearfix ">
  ...
  <div class="container">  
		...
		<div class="table-responsive">
				...
				if($get_redemption)
				{
					...
					?>
                      <tr>
						...
						<?php if($k<=4) {?> <p>( can be used for mobile or DTH recharges)</p><?php } ?></td>
                      </tr>
                    <?php
					$k++;
					}
				...
				<span class="price fnt-18"> <strong><?php echo $ads_points; ?> </strong> </span>
				<hr>                
                <p class="text-center"> 
				<button type="button" class="btn btn-primary bor-rad-no" data-toggle="modal" data-target="#myModal_redumption"> Redeem Now </button>
				</p>                
                <h5 class="clr-red" style="display:none;">You dont have enough points to redeem</h5>                
                <p class="text-center"><a href="<?php echo base_url(); ?>/ads_faq" class="text-center">Click here to view all redeem details</a></p>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
	   ...
	   <form action="#" method="post" class="form-horizontal tabular-form">
      <div class="modal-body">
			<h2 class="text-center">Your Available ADS Coins : <span style="color: red; font-weight: bold;">510</span></h2>
       
							<input type="hidden" value="" id="user_id" name="user_id">
							
								
						<div class="form-group">
							<label for="form-password" class="col-sm-4 control-label">Amount</label>
						...
						<div class="form-group">
							...
							<div class="col-sm-8 tabular-border">
								<input type="password" autocomplete="off" required="" class="form-control" name="key" id="key">
	  ...
	  <input type="submit" value="Submit" class="btn-danger btn bor-rad-no" id="save" name="save" onclick="return validationset();"> 
