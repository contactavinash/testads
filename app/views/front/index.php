          ...
          <div class="search_top">
            <form>
              <div class="input-group">
                <div class="input-group-addon inr_cat"> <a aria-expanded="false" aria-haspopup="true" role="button" data-toggle="dropdown" class="dropdown-toggle" href="#" id='get_cate_id'>Categories <span class="caret"></span></a>
...
<li> <a href="<?php echo base_url(); ?>cashback/logout"> <i class="fa fa-sign-out"> Logout</i></a> </li>
		...
		<div role="group" class="btn-group"> 
		<button aria-expanded="false" aria-haspopup="true" data-toggle="dropdown" class="btn btn-org dropdown-toggle" type="button" id="btnGroupVerticalDrop1"><?php echo $offline_userdet->user_name; ?> <span class="caret"></span> 
		</button> 
		<ul aria-labelledby="btnGroupVerticalDrop1" class="dropdown-menu"> 
		<li><a href="<?php echo base_url(); ?>view_stores">My account</a></li>
  ...
  <div class="">
    <div class="container">
      <div class="row">
         ...
         <!-- <div class="cls_new_head"> <i class="fa fa-ticket"></i><span class="mar-lft"><a href="http://offline.achadiscount.in/#/listings/-1/<?php echo $lat;?>/<?php echo $lng;?>" style="color:#FFF;" target="_blank"> More Offline Discounts Sale Around You</a></span>  </div> -->
          
          <div id="offline" class="hiddenf_more flyout_more 8 col-md-10" style="margin-left:36px;">
        ...
        <div class="flyout hiddenf cls_inner_cate col-md-10"  style="margin-left:36px;" id='online'>
    	 <div class="hero">
            <div id="vertical" class="hovermenu ttmenu dark-style menu-red-gradient">
                <div class="navbar navbar-default" role="navigation">
                    <div class="navbar-header">
        ...
        <div class="col-md-4 col-sm-4 more_off_coupon" custom="coupon">
          ...
          <div id="coupon" class="hiddenf_more flyout_more " style="margin-left:36px;">
          
          <div class="hero">
            <div id="vertical" class="hovermenu ttmenu dark-style menu-red-gradient col-md-11 col-sm-10">
                <div class="navbar navbar-default" role="navigation">
                    <div class="navbar-header">
                        <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target=".navbar-collapse">
                        <span class="sr-only">Toggle navigation</span>
			...
			<a href="http://offline.achadiscount.in/#/saledetails/<?php echo $hot_off->id; ?>" target="_blank">
              ...
              <div class="row">
                <div class="col-md-5 col-sm-4 col-xs-4">
                  <div><img  class="img-responsive" src="http://offline.achadiscount.in/admin/uploads/<?php echo $hot_off->image; ?>" style="height:80px;"> </div>
                </div>
...
if($ho==3){break;}		  } ?>
      ...
      <div class="col-md-5 col-sm-12">
        ...
        foreach($result as $imgs)
        {
          ...
          $img_name = $imgs->banner_heading;
        ?>
              <div class="item <?php if($sk==1){ echo 'active'; }?>"> <a href='<?php echo $banner_url; ?>' target='_blank'>
                <img src="<?php echo base_url().'uploads/banners/'.$view_img; ?>" alt="<?php echo $img_name; ?>" title="#<?php echo $img_name; ?>" > </a>
              </div>
              ...
              <div class="cls_pro_bg">
                <div class="image01"> 
				  ...
				  <?php if($user_id!=''){ ?>
                    ...
                    <a class="fa fa-link" href="<?php echo base_url().'visit_product/'.$lasproduct->pp_id.'/'.$getminpricesim_row->product_id;?>" target="_blank"></a> 
				  <?php }
else{
	$surl=base_url().'visit_product/'.$lasproduct->pp_id.'/'.$getminpricesim_row->product_id;
	?>
 <a class="fa fa-link" data-toggle="modal" data-target="#myModal" onclick="return get_url('<?php echo $surl; ?>');"></a>
...
<?php 
                ...
                <div class="border_bot" style="height:40px;">
                   <?php
          ...
          <div class="col-md-12 col-sm-12">
			...
			<?php foreach($hot_brands as $brands){ ?>
              <div class="item">
                <div class="cls_img-pats">
                <a href="http://offline.achadiscount.in/#/branddetails/<?php echo $brands->id; ?>" target="_blank">
                <img  class=" img-responsive" src="http://offline.achadiscount.in/admin/uploads/<?php echo $brands->image; ?>" alt="" style="height:100%">
                </a> 
                </div>
              </div>
			  <?php } ?>
			...
			if($coupons->type=='Promotion')
{
  ...
  <div class="cls_brnad_bg center-block" align="center">
       <a href="<?php echo base_url();?>products/<?php echo $brand_name->brand_url;?>_brands/mobile-phones_1#brands=<?php echo $brand_name->brand_url;?>#mobile-phones_1" class=""> 
...
function showLocation(position) {
	...
	$.ajax({
		...
		url:'<?php echo base_url(); ?>/cashback/getgeo',
...
function go_acha()
{
	...
	var lat=$('#lat').val();
	var lng=$('#lng').val();
	window.open('http://offline.achadiscount.in/#/listings/'+id+'/'+lat+'/'+lng, '_blank');
	 win.focus();
}
