<?php
$admis = $this->front_model->getadmindetails_main();
//echo '<pre>';
//print_r($admis);die;
$amount = $coupon_id->amount;
//echo $amount;die;
//print_r($user_details);die;
$phone= $user_details->contact_no;
...
// Merchant key here as provided by Payu
 $MERCHANT_KEY = $admis->merchant_key;

 $SALT = $admis->merchant_salt;
...
<td colspan= "3"><input name="surl" value="<?php echo base_url();?>cashback/success_withdraw/<?php echo insep_encode($coupon_id->coupon_id); ?>" size="64" type="hidden"/></td>
</tr>
<tr>

<td colspan="3"><input name="furl" value="<?php echo base_url();?>cashback/coupons" size="64" type="hidden"/></td>
</tr>
