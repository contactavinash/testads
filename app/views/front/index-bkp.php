...
<div class="wrap-top">
  <div id="content">
	...
	{
	?> 
	<li><?php echo anchor('cashback/products/'.$view->category_url,$view->category_name); ?></li> <li> | </li>
	<?php } ?>
        </ul>
      </div>
...
<!--            <span>
 ...
 <iframe class="embed-responsive-item" src='http://www.flipkart.com/affiliate/displayWidget?affrid=WRID-142165939892256859' width="100%"></iframe>
            ...
            ?>
           <a href="<?php echo $headerimg->ads_url?>"> <img src="<?php echo base_url(); ?>uploads/ads/<?php echo $headerimg->ads_image?>" class="img-responsive mar20" alt=""></a>
            </div>
            ...
            <?php
              ...
              <div>
                            <div class="bg-holder">
                              <a href="<?php echo $banner_url;?>">  <img src="<?php echo base_url().'uploads/banners/'.$view_img; ?>" alt="" class="img-responsive" height="408" width="776" /></a>
                              ...
                              <a href="<?php echo $banner_url;?>">   <img src="<?php echo base_url().'uploads/banners/'.$view_img; ?>" alt="" class="img-responsive sli-img" width="776" height="408" /></a>
                            </div>
                        </div>
				<?php } ?>	
            </div>
          ...
          <div class="col-md-3">
            ...
            ?>
             ...
             <a href="<?php echo $headerimg4->ads_url?>"> <img src="<?php echo base_url(); ?>uploads/ads/<?php echo $headerimg4->ads_image?>" class="img-responsive mar20" alt=""></a>
...
<div class="detailholder">
  <h4 class="showbiz-title txt-center"><a href="#"><?php echo substr($featured_produc->offer_name,0,9)."...";   ?></a></h4>
  <div class="divide5"></div>
  <p class="txt-center"><?php echo substr($featured_produc->title,0,54)."...";  ?> </p>
</div>
    ...
    <div class="heightadjuster table"> 
      ...
      <div class="table-cell pl20">
        ...
        <p class="orange bigger bolder">
          <?php // echo $featured_produc->offer_percentage; ?>
        </p>
            ...
            <div class="col-md-3 col-sm-3 col-xs-12">
				...
				echo anchor('cashback/stores/'.$stores->affiliate_url,'<img src="'.base_url().'uploads/affiliates/'.$stores->affiliate_logo.'" style="height:100%"  class="img-responsive">',$confirm); ?>
                 ...
                 <!-- <img src="<?php echo base_url();?>front/images/store-img-1.png" class="img-responsive center-block mar20 img-hgt">-->
                    ...
                    <div class="caption">
                      <div class="caption-content"> <a class="animated fadeInDown" href="<?php echo base_url();?>cashback/stores/<?php echo $stores->affiliate_url;?>"><i class="fa fa-link fa-2x"></i></a>
                        <a href="<?php echo base_url();?>cashback/stores/<?php echo $stores->affiliate_url;?>"> <h4>Go To <?php echo $stores->affiliate_name;?></h4></a>
                      </div>
                    </div>
                  </div>
                </div>
      ...
      <section class="recent">
        <div class="row">
          <div class="col-md-3">
			...
			{				
			?>
           	<a href="<?php echo base_url(); ?>index.php/cashback/detailspage/<?php echo $recently_view->product_id; ?>"> 
            <img  src="<?php echo base_url(); ?>uploads/premium/<?php echo $recently_view->image; ?>" class="img-responsive center-block"></a>
              <p class="text-center"><?php echo $recently_view->name; ?> </p>
              <p class="clr-blu text-center">Rs.<?php echo $recently_view->price; ?></p>
              <hr>
             <?php
			}
			 ?>
                    ...
                    <div class="col-sm-4 col-md-4 col-xs-12">
                      <div class="featured-item-container">
                        <div class="featured-item">
                          ...
                          <div class="logotype">
                            <div class="logotype-image"> <center>  <a href="<?php echo base_url();?>cashback/stores/<?php echo $stores->affiliate_url;?>"> <?php echo $update_lo;?></a> </center> </div>
                          </div>
                          <div class="featured-item-content"> <a href="<?php echo base_url();?>cashback/stores/<?php echo $stores->affiliate_url;?>">
                           <center> <h4><?php echo $affiliate_name;?></h4></center>
                            </a>
                            <center>  <p><a href="<?php echo base_url();?>cashback/stores/<?php echo $stores->affiliate_url;?>" title="<?php echo $stores->affiliate_name; ?>">
                                        <?php if($stores->cashback_percentage)
										{ 
											if($stores->affiliate_cashback_type=="Percentage")
											{
										...
										echo 	$cppercentage;?>  <?php }?> Cashback
                                        <?php
										}
										?>
                                        <?php
                          ...
                          <div class="item-meta">
							...
							?>
                             <!-- <li class="pull-right"> <a href="<?php echo base_url();?>cashback/stores/<?php echo $stores->affiliate_url;?>"> <span class="fa fa-plus-square"></span> </a>--> </li>
                            </ul>
                          </div>
                        </div>
                      </div>
             ...
             <!--
              <div class="carousel slide" id="carousel" data-ride="carousel">
                <div class="carousel-inner">
                  <div class="item active">
                    <div class="col-sm-4 col-md-4 col-xs-12">
                      <div class="s-item respl-item "> <img src="<?php echo base_url();?>front/images/store-img-10.png" class="img-responsive  pad9 ">
                        <div class="s-caption">
                          <p class="pad">Minimum 55% off on Fashion For Men & Women</p>
                          <div class="clearfix"> <a class="btn btn-warning mar-rht pop" href=""> Activate Deal </a> </div>
                          <hr>
                          <div class="box-tags clearfix">
                           <ul class="list-inline clearfix mar-no">
                           
                           <li><i class="fa fa-clock-o pad-rht clr-blu"></i> <a href="">5 days </a></li>
                           
                           <li><i class="fa fa-info-circle pad-rht clr-blu"></i> <a href="">Terms </a></li>
                           
                           <li> <i class="fa fa-plus-square clr-blu"></i></li>
                          </ul>
                          </div>
                        </div>
                      </div>
    ...
    <div class="divider subscribe">
      <div class="container">
        <div class="pull-left pad-rht">
          ...
          <div class="">
            <h2>Sign up for <?php $admindetails = $this->front_model->getadmindetails_main(); echo $admindetails->site_name; ?> Exclusive Offers!</h2>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="cls_cash_back_works">
            ...
            <p><?php $admindetails = $this->front_model->getadmindetails_main(); echo $admindetails->site_name; ?>.com is India's No.1 website to save on all your online shopping. We give you EXTRA CASHBACK when you shop at any of our 500+ partner brands. This is over and above Coupons and Discounts that might already be running on the retailer's website. Just remember to go via <?php $admindetails = $this->front_model->getadmindetails_main(); echo $admindetails->site_name; ?> & shop. We get paid commission which we pass to you as Cashback.. </p>
          </div>
        </div>
        <div> </div>
      </div>
...
<script type="text/javascript" src="<?php echo base_url();?>front/js/category/jquery.themepunch.plugins.min.js"></script> 
<script type="text/javascript" src="<?php echo base_url();?>front/js/category/jquery.themepunch.showbizpro.min.js"></script> 
<script type="text/javascript">
