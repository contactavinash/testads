...
<title>Offline Reset Password | <?php $admindetails = $this->front_model->getadmindetails_main(); echo $admindetails->site_name; ?></title>
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12">
		...
		?>
			<input type="hidden" name="user_id" value="<?php echo $offline_userid;?>" id="" >
          <div class="fieldset">
            <div class="form-list">
