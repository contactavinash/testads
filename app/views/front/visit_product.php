...
if(!isset($redirect)){
$redirect_url = redirect_handler1($scrappingdetails,$store_details,$this->front_model);
} else {
$redirect_url = redirect_handler_store1($redirect,$store_details,$this->front_model);;
}
...
<div id="content">
 <!-- <section class="breadcrumb-sec clearfix">
  <div class="container">
    <div class="breadcrumb clearfix"> <a href="<?php echo base_url();?>" class="home">Home</a> <span class="navigation-pipe">&gt;</span> Visit Product</div>
  </div>
</section>-->
...
<div id="magik-slideshow" class="magik-slideshow">
    <div class="container">
         ...
         <img style="margin-top:30px;" src="<?php echo base_url();?>uploads/adminpro/<?php echo $admindetails[0]->site_logo;?>" class="img-responsive pull-left ">
...
<div class="col-md-6 col-md-offset-2">
    <center>
<img src="<?php echo base_url();?>front/images/visit_shop.gif" class="img-responsive" >
</center>
        </div>    
