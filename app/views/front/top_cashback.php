		...
		?>
            <div class="filters">
              <ul class="nav nav-pills">
                ...
                <li class=""><a data-filter=".feature" style="background-color:#e74955;" href="javascript:void(0);">Feature</a></li>
                <li class=""><a data-filter=".store" style="background-color:#a5d16c;" href="javascript:void(0);">Store of the Week </a></li>
                <li class=""><a data-filter=".offers" style="background-color:#32c2cd;" href="javascript:void(0);">Offers</a></li>                
              </ul>
            </div>
            <div class="row">
                          ...
                          <div class="product-block">
                            ...
                            <div class="image ">
                              <div class="product-img img">
                                <a href="<?php echo base_url();?>stores/<?php echo $stores->affiliate_url;?>" target="_blank;" class="product-image img" title="<?php echo $stores->affiliate_name; ?>"><img style="height:50px;width:111px;"  src="<?php echo $img_url;?>"  class="img-responsive center-block">
                                </a>  
                            ...
                            <div class="product-meta product-shop">
                              <h3 class="product-name name"><a href="<?php echo base_url();?>stores/<?php echo $stores->affiliate_url;?>" target="_blank;" title="<?php echo $stores->affiliate_name; ?>">
								...
								<div class="cart mar-top"> <a href="<?php echo base_url();?>stores/<?php echo $stores->affiliate_url;?>" target="_blank;" title="<?php echo $stores->affiliate_name; ?>">
