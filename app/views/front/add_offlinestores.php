...
<div class="all clearfix">
      ...
      echo form_open('add_offlinestores',$atrtibute);
    ?>
        <div class="fieldset">
          ...
          <div class="col-md-8">  
            ...
            <div class="col-md-8">
                ...
                <!-- <input id="address1" type="text" placeholder="Type in an address"  name="address" class="input-text required-entry form-control" required> -->
                 <input id="autocomplete1"  data-id='1' placeholder="Enter your address"
             onFocus="geolocate()" type="text" name="address[]" class="input-text required-entry form-control autos"></input>
          ...
          <input name="street_number[]" id="street_number1" type="hidden" value="">


      <!--    <label>street address</label> -->
          <input name="route[]" type="hidden" id="route1" value="">


       <!--   <label>Latitude</label> -->
          <input name="lat[]" type="hidden" id="lat1" value="">

          <!-- <label>Longitude</label> -->
          <input name="lng[]" type="hidden" id="lng1" value="">


      <!--    <label>Postal Code</label>  -->
          <input name="postal_code[]" id="postal_code1" type="hidden" value="">

         <!-- <label>Country</label> -->
          <input name="country[]" id="country1" type="hidden" value=""> 

            <!--    <label>City</label> -->
          <input name="locality[]" id="locality1" type="hidden" value="">
...
//alert(nn);
      ...
      function initAutocomplete() {
        ...
        autocomplete = new google.maps.places.Autocomplete(
            /** @type {!HTMLInputElement} */(document.getElementById('autocomplete'+nn)),
            {types: ['geocode']});
       ...
       $("#lng1").val(longgggg[1]); 
        ...
        for (var component in componentForm) {
          ...
          document.getElementById(component).disabled = false;
            ...
            $("#route"+nn).val(place.address_components[0][componentForm['route1']]); 
           

              $("#locality"+nn).val(place.address_components[2][componentForm['locality1']]);  
              $("#administrative_area_level_1"+nn).val(place.address_components[4][componentForm['administrative_area_level_11']]);  
              $("#country"+nn).val(place.address_components[5][componentForm['country1']]);  
              $("#postal_code"+nn).val(place.address_components[6][componentForm['postal_code1']]);   
