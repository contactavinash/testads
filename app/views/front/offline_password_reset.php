...
<body>
<?php $offline_userid = $this->session->userdata('offline_user_id'); ?>
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <?php
				...
				echo form_open('offline_password_reset/',$attribute);
		?>
          ...
          <div class="fieldset">
            <div class="form-list">
              ...
              <div class="input-box">
                <input type="password" name="new_password" alt="new_password" id="new_password" class="input-text required-entry  validate-email" value="" />
              </div>
			...
			<div class="form-list">
              ...
              <div class="input-box">
                <input type="password" name="confirm_password" alt="confirm_password" id="confirm_password" class="input-text required-entry validate-email" value="" />
              </div>
