...
$(document).on('click', '.number-spinner button', function () {    
	...
	var setname_val = $('#hid_user_quan_'+ref_value).val();;
	if(max_value>=newVal && newVal<=setname_val)
	//if(max_value>=newVal)
	{
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <ol class="breadcrumb">
                                ...
                                <li class=""><a href="<?php echo base_url();?>cashback/cart_listing_page">My Cart</a></li>
                            </ol>
                        </div>
                    </div>
                </div>
...
<form action="<?php echo base_url();?>index.php/cashback/PayUmoney" method="post" id="checkout" name="checkout">
	...
	<table id="cart" class="table table-hover table-condensed">
                    ...
                    <?php $new_check_out=''; $sub_total=0; $i=0; if($cart) { 
					
					foreach($cart as $carts) {  $i++;
					...
					$db_coupon_image=$product_details->coupon_image;
					 ...
					 ?>
						<tr>
							<td data-th="Product">
								<div class="row">
									<div class="col-sm-2 hidden-xs"><img width="250" height="250" src="<?php echo base_url(); ?>uploads/premium/<?php echo $exp_db_coupon_image[0]; ?>" alt="..." class="img-responsive"/></div>
									<div class="col-sm-10">
							...
							<td data-th="Price"><?php echo DEFAULT_CURRENCY_CODE." ".$product_details->amount ?></td>
							<td data-th="Quantity">
                            ...
                            <input type="hidden" name="hid_user_quan_<?php echo  $i; ?>" value="<?php echo $product_details->user_max;?>" id="hid_user_quan_<?php echo  $i; ?>">
						</tr>
...
<?php                            if($new_check_out!='') {  ?>
							<td class="hidden-xs text-center"><strong>Total <?php echo DEFAULT_CURRENCY_CODE;?><input  class="form-control text-center" type="text" id="sub_tot" name="sub_tot" value="<?php echo $sub_total; ?>" readonly></strong></td>
	...
	<table id="pay" class="table table-hover table-condensed" style="display:none">
    				<thead>
						<tr>
							...
							<th width="8%" style="width:30%"><center>PayUMoney (Credit / Debit Card / Netbanking via PayUMoney)</center> </th>
							<th width="21%" style="width:30%" id="h_site"><center>Pay using <?php $admis = $this->front_model->getadmindetails_main(); echo $admis->site_name; ?> Balance </center></th>
						</tr>
					</thead>
					<tbody>
						<tr>
