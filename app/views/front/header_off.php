...
if($site_mode==0)
{
  redirect('under_maintance','refresh');
}
    ...
    <div class="cls_head_main">
      ...
      <div class="col-md-3 col-sm-3">
        ...
        <div class="col-sm-5 col-md-5">
          <div class="search_top">
            <form>
              ...
              ?>
                  ...
                  <input type="text" placeholder="Search" id="search" class="form-control input-text search_header" value="<?php  if(isset($_POST['storehead'])){echo $storehead;}?>">
         ...
         <?php if($offline_userid!=''){
          $offline_userdet = $this->front_model->offline_userdet($offline_userid); 
          ?>
        <div class="col-md-4 col-sm-4">
		
		<div role="group" class="btn-group"> 
		<button aria-expanded="false" aria-haspopup="true" data-toggle="dropdown" class="btn btn-org dropdown-toggle" type="button" id="btnGroupVerticalDrop1">
      <?php echo $offline_userdet->user_name; ?>
		</button> 
	<!-- 	<ul aria-labelledby="btnGroupVerticalDrop1" class="dropdown-menu"> 
		<li><a href="<?php echo base_url(); ?>cashback/my_earnings">My account</a></li>
		<li><a href="<?php echo base_url(); ?>cashback/favorites">Wish list</a></li>
<li><a href="<?php echo base_url(); ?>cashback/logout">Logout</a></li>		
		</ul>  -->
		</div>
          <!--<div class="clslogin">
         ...
         <?php } 
          ...
          <div class="clslogin">
			...
			<!-- 	 <li> 
              ...
              <li> <a href="#"> | </a></li>
              <li><a href="<?php echo base_url(); ?>offline_register"> <i class="fa fa-sign-out"> Register</i></a> </li>
            </ul>
          </div>
        </div>
