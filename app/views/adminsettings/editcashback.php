...
<head>
  ...
  <title>Cashback Details | <?php echo $admin_details->site_name; ?> Admin</title>
...
<body class="fixed-top">
               ...
               <div class="span12">
                  ...
                  <h3 class="page-title">
                   ...
                   <ul class="breadcrumb">
                       ...
                       <li>
							<?php echo anchor('adminsettings/cashback','Cashback Details'); ?>
               ...
               <div class="span12">
                  ...
                  <div class="widget">
                     <div class="widget-title">
                        <h4><i class="icon-file"></i> Cashback Details</h4>
                        <span class="tools">
					...
					<?php
                        ...
                        <!-- BEGIN FORM-->
						<?php
							$attribute = array('role'=>'form','name'=>'addcashback','method'=>'post','id'=>'addcashback','class'=>'form-horizontal','enctype'=>'multipart/form-data');
							echo form_open('adminsettings/updatecashback',$attribute);
						?>

						   <div class="control-group">
                              <label class="span3">Current Cashback Status </label>
                              <div class="controls">
						   ...
						   <div class="control-group">
                             <label class="span3">Store Name </label>
                              <div class="controls">
								<label class="span6"><?php	
									echo $store_name = $this->admin_model->view_store($store);
								?></label>
                              </div>
                           </div>

						<!--   <div class="control-group">
                              <label class="span3">Promo ID </label>
                              <div class="controls">
								<label class="span6"><?php // get Promo Id from coupon id..
									echo $view_promo = $this->admin_model->view_promo($coupon_id);
								?></label>
                              </div>
                           </div>-->
						    ...
						    <div class="control-group">
                              ...
                              <div class="controls">
								<label class="span6"><?php // view user email..
									$email = $this->admin_model->user_email($user_id);
									$attr = array('target'=>'_blank');
									echo anchor('adminsettings/view_user/'.$user_id,$email,$attr);			
									?></label>
                              </div>
                           </div>

						   <div class="control-group">
                             <label class="span3">Cashback </label>
                              <div class="controls">
								<label class="span6"><?php // cashback % from store..
									echo $from_store = $this->admin_model->get_fromstore($store);
									?> %</label>
                              </div>
                           </div>
						   
						   <input type="hidden" name="hidden_percentage" id="hidden_percentage" value="<?php echo $from_store; ?>">
						   
						   <div class="control-group">
                             <label class="span3">Total Amount of Purchase (in <?php echo DEFAULT_CURRENCY_CODE;?>) </label>
                              <div class="controls">
								<input type="text" name="amount" id="amount" class="span3" onKeyUp="return doCalc();">
                              </div>
                           </div>
						   
						   <div class="control-group">
                              <label class="span3">Cashback Amount (in <?php echo DEFAULT_CURRENCY_CODE;?>)</label>
                              <div class="controls">
								<label class="span6" id="result">0</label>
                              </div>
                           </div>
						   <?php // to check if the user is referral user..
							$result = $this->admin_model->check_refer($email);
							if($result > 0){
						   ?>
						   <div class="control-group">
                              <label class="span3">Referral Cashback </label>
                              <div class="controls">
								<label class="span6" id="">
								<?php echo $referral_cashback = $this->admin_model->get_referral_percent();	?> %
								</label>
                              </div>
                           </div>
						   
						   <div class="control-group">
                              <label class="span3">Referral User Amount</label>
                              <div class="controls">
								<label class="span6">
								<?php
						   ...
						   <input type="hidden" name="cashback_id" id="cashback_id" value="<?php echo $cashback_id; ?>">
  ...
  <?php $this->load->view('adminsettings/footer'); ?>
   ...
   <script type="text/javascript">
	function doCalc() { 
		var percentage = $('#hidden_percentage').val();
		var amt = $('#amount').val();
		
		var total = (parseInt(amt) * (parseInt(percentage)/100));
