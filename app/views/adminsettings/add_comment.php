...
<head>
  ...
  <title>Add Comment | <?php echo $admin_details->site_name; ?> Admin</title>
               ...
               <div class="span12">
                  ...
                  <h3 class="page-title">
                   ...
                   <ul class="breadcrumb">
                       ...
                       <li>
							<?php echo anchor('adminsettings/get_allcomments/'.$blog_id,'Add Comment'); ?>
							<span class="divider">&nbsp;</span>
                       </li>
					   <li>
							Add Comment<span class="divider-last">&nbsp;</span>
                       </li>
                   </ul>
               </div>
            </div>
               ...
               <div class="span12">
                  ...
                  <div class="widget">
                     <div class="widget-title">
                        <h4><i class="icon-file"></i> Add Comment</h4>
                        <span class="tools">
				...
				if($success!="") {
						...
						<?php
							...
							echo form_open('adminsettings/add_comments',$attribute);
						?>
                        <input type="hidden" name="blog_id" value="<?php echo $blog_id;?>">
                           ...
                           <div class="control-group">
                              ...
                              <div class="controls">
                                <textarea class="span6" name="comments" rows="5" id="comments" required></textarea>	
                              </div>
                           </div>
