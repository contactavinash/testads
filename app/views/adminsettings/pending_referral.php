					...
					<?php
						...
						if($success!="") {
                         ...
                         <form id="form2" action="" method="post" name="form2">
                            <table class="table table-striped table-bordered" <?php if($coupons){ ?>id="sample_1"<?php } ?>>
                            <thead>
                                <tr>
                                    <th>#</th>
							...
							?>
								...
								<?php
                                    ...
                                    <td><?php echo $coupon->transation_reason; ?></td>
                                     <td><?php echo DEFAULT_CURRENCY." ".$coupon->transation_amount; ?></td>
                                     
                                      <td><center><?php
									  if($coupon->transation_status=='Paid')
									  {
										  ?>
                                          <span class="label label-success"><?php echo $coupon->transation_status;?></span>
                                          <?php
										  }
										  else
										  {
										   ?>
                                          <span class="label label-info"><?php echo $coupon->transation_status;?></span>
                                        <?php
										}
									  ?></center>
									  </td>
									...
									echo anchor('adminsettings/pending_referral/approve/'.$coupon->trans_id,'<button class="btn btn-success" type="button">Approve</button>',$confirm); ?>
                                       ...
                                       <td>
                                       <?php echo date('d F Y',strtotime($coupon->transation_date)); ?></td>
                                </tr>
								<?php } } else { ?>
								<tr>
