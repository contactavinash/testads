...
<head>
  ...
  <title>Upload Report | <?php echo $admin_details->site_name; ?> Admin</title>
               ...
               <div class="span12">
                  ...
                  <h3 class="page-title">
                   ...
                   <ul class="breadcrumb">
                       ...
                       <li>
							<?php echo anchor('adminsettings/bulk_store','Upload Reports'); ?>
               ...
               <div class="span12">
                  ...
                  <div class="widget">
                     <div class="widget-title">
                        <h4><i class="icon-file"></i> Upload Reports</h4>
                        <span class="tools">
					...
					<?php
						...
						<?php
							...
							echo form_open('adminsettings/report_upload',$attribute);
						?>
						 ...
						 <!--  <div class="control-group">
						   ...
						   <div class="control-group">
                              ...
                              <div class="controls">
                                <input type="file" name="bulkcoupon" id="bulkcoupon"><span style="margin-left: 10px;"><a style="color: rgb(135, 206, 4);" href="<?php echo base_url(); ?>uploads/csv_examples/reports.csv"><img align="absmiddle" src="<?php echo base_url(); ?>front/images/csv.png"> example.csv</a></span>
								<br>
