                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <ol class="breadcrumb">
                                ...
                                <li class=""><a href="<?php echo base_url();?>cashback/top_cashback">Top Cashback Offers</a></li>
        ...
        <div class="row">
          <div class="col-md-3">
            <aside class="sidebar-left store-title">
              ...
              <ul class="nav nav-tabs nav-stacked nav-coupon-category nav-coupon-category-left">
                <li class="active"><?php echo anchor('cashback/top_cashback','<i class="fa fa-ticket"></i>All'); ?> </li>
                <?php 
                ...
                <li class="dynamiccls" <?php echo $extracss." "; 
										...
										?>>
										<a <?php echo $s;?> onClick="runcheck_1('<?php echo 'cashback/top_cashback/'.$view->category_url;?>');" href="<?php echo base_url().'cashback/top_cashback/'.$view->category_url;?>"><i class="fa fa-arrow-circle-right"></i><?php echo $view->category_name;?></a>
                                         <?php
										...
										if(count($subcate)!=0)
										{
											if($subcate)
											{
												...
												foreach($subcate as $subcatelist)
												{
													...
													<li <?php echo $kt;?>><?php echo anchor('cashback/top_cashback/'.$category_url.'/'.$sub_category_url,$sub_category_name); ?></li>
													<?php
												}
												echo " </ul>";
											}
          ...
          <section class="main-content col-md-9">
            <div class="store-title">
              <h3 class="mar-no mar-bot20">All Top cashback offers </h3>
            </div>
            <?php
		   ...
		   ?>
            <div class="filters">
              <ul class="nav nav-pills">
                ...
                <li class=""><a data-filter=".feature" style="background-color:#e74955;" href="#">Feature</a></li>
                <li class=""><a data-filter=".store"  style="background-color:#a5d16c;" href="#">Store of the Week </a></li>
                <li><a data-filter=".offers"  style="background-color:#32c2cd;" href="#"> Offers</a></li>
              </ul>
            </div>
            <div class="row">
