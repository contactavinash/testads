               ...
               <div class="span12">
                  ...
                  <h3 class="page-title">
                   ...
                   <ul class="breadcrumb">
                       ...
                       <li>
							<?php echo anchor('adminsettings/site_affiliates','Direct Affiliates'); ?>
							<span class="divider">&nbsp;</span>
                       </li>
					   <li>
               ...
               <div class="span12">
                  ...
                  <div class="widget">
                     <div class="widget-title">
                        <h4><i class="icon-file"></i> Direct Affiliates</h4>
                        <span class="tools">
					...
					<?php
						...
						$sess_affiliate_type = $this->session->flashdata('affiliate_type');
							...
							echo form_open('adminsettings/site_addaffiliate',$attribute);
						?>
						
                       
                       
                            <input type="hidden" name="affiliate_status" value="1">
                           <input type="hidden" name="affiliate_type" value="Direct" >
                           ...
                           <div class="control-group extra_hidden">
                              <label class="control-label">Affiliate id <span class="required_field">*</span></label>
                              <div class="controls">
                                <input type="text" class="span6" name="affiliate_param" id="affiliate_param" value="" placeholder="Eg : tag=cashinkart-21" required />
                              </div>
                           </div>
						   ...
						   <div class="control-group extra_hidden">
                              <label class="control-label">Tracking Param Name 2<span class="required_field"></span></label>
                              <div class="controls">
                                <input type="text" class="span6" name="affiliate_traking_param2" id="affiliate_traking_param2" placeholder="Eg : ascsubtag2" value=""  />
                              </div>
                           </div>
                             <div class="control-group extra_hidden">
                              <label class="control-label">Affliates URL</label>
                              <div class="controls">
                                <input type="text" class="span6" name="aff_url" rows="5" id="aff_url">	
                              </div>
						   </div>
						 <!--</span>-->
				...
				if($success!="") {
						...
						<?php
							...
							echo form_open('adminsettings/site_updateaffiliate',$attribute);
						?>
						   ...
						   ?>
                            ...
                            <div class="control-group extra_hidden">
                              ...
                              <?php
								...
								{
							 	 ?>							     
								  <option <?php if($res->affiliate_id==$affiliate_name){ echo 'selected="selected"'; } ?> value="<?php echo $res->affiliate_id;?>"><?php echo $res->affiliate_name;?></option>
	                           	 <?php
								}
							  ?>
                               </select>
                           ...
                           <div class="control-group extra_hidden">
                              <label class="control-label">Affiliate id <span class="required_field">*</span></label>
                              <div class="controls">
                                <input type="text" class="span6" name="affiliate_param" id="affiliate_param" value="<?php echo $affiliate_param;?>" placeholder="Eg : tag=MR10Q-21" required />
                              </div>
                           </div>
                           ...
                           <div class="control-group extra_hidden">
                              <label class="control-label">Tracking Param Name<span class="required_field">*</span></label>
                              <div class="controls">
                                <input type="text" class="span6" name="affiliate_traking_param" id="affiliate_traking_param" placeholder="Eg : ascsubtag" value="<?php echo $affiliate_traking_param;?>" required />
                              </div>
                           </div>
						   ...
						   <div class="control-group extra_hidden">
                              <label class="control-label">Tracking Param Name 2<span class="required_field"></span></label>
                              <div class="controls">
                                <input type="text" class="span6" name="affiliate_traking_param2" id="affiliate_traking_param2" placeholder="Eg : ascsubtag2" value="<?php echo $affiliate_traking_param2;?>"  />
                              </div>
                           </div>
						      <div class="control-group">
                              <label class="control-label">Affliates URL</label>
                              <div class="controls">
                                <input type="text" class="span6" name="aff_url" rows="5" id="aff_url" value="<?php echo $aff_url; ?>">	
                              </div>
						   </div>
