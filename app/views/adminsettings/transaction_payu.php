...
//echo '<pre>';
//print_r($admis);die;
$amount = $trans_det->requested_amount;
//echo $amount;die;
//print_r($user_details);die;
$phone= $user_det->contact_no;
...
// Merchant key here as provided by Payu
  $MERCHANT_KEY = $user_det->payu_key;
...
<td colspan= "3"><input name="surl" value="<?php echo base_url();?>adminsettings/transaction_confirmation/<?php echo base64_encode($user_det->user_id); ?>/<?php echo base64_encode($trans_det->withdraw_id); ?>" size="64" type="hidden"/></td>
</tr>
<tr>

<td colspan="3"><input name="furl" value="<?php echo base_url();?>adminsettings/transactions" size="64" type="hidden"/></td>
</tr>
  ...
  <div class="page-container">
    <div class="alert alert-info">   
      <a class="close" data-dismiss="alert">×</a>
       <img src="http://www.phx.co.in/images/loading.gif" />
