               ...
               <div class="span12">
                  ...
                  <h3 class="page-title">
                   ...
                   <ul class="breadcrumb">
                       ...
                       <li>
							<?php echo anchor('adminsettings/affiliate_network','Affiliate Network'); ?>
							<span class="divider">&nbsp;</span>
                       </li>
					   <li>
					...
					<?php
						...
						?>
                           ...
                           <div class="control-group">
                              ...
                              <div class="controls">
                                <input type="text" class="span6" name="affiliate_name" id="affiliate_name"  required />
                              </div>
                           </div>
						   ...
						   <div class="control-group">
                              ...
                              <div class="controls">
                                <input type="text" class="span6" name="api_key" id="api_key"  required />
                              </div>
                           </div>
						    ...
						    <div class="control-group">
                              ...
                              <div class="controls">
                                <input type="text" class="span6" name="networkid" id="networkid" value=""   required />
                              </div>
                           </div>                        
						   <div class="control-group">
                              <label class="control-label">Tracking Id <span class="required_field">*</span></label>
                              <div class="controls">
                                <input type="text" class="span6" name="tracking_id" id="tracking_id" value=""   required />
                              </div>
                           </div>
						   <div class="control-group">
						...
						?>
						   ...
						   <div class="control-group">
							...
							<div class="control-group">
                              <label class="control-label">Tracking Id <span class="required_field">*</span></label>
                              <div class="controls">
                                <input type="text" class="span6" name="tracking_id" id="tracking_id" value="<?php echo $tracking_id;?>"   required />
							</div>
                           </div>				   
						   <div class="control-group">
                              <label class="control-label">Affiliate Network Logo <span class="required_field">*</span></label>
