...
<head>
  ...
  <title>Reply contact | <?php echo $admin_details->site_name; ?> Admin</title>
               ...
               <div class="span12">
                  ...
                  <h3 class="page-title">
                   ...
                   <ul class="breadcrumb">
                       ...
                       <li>
							<?php echo anchor('adminsettings/contacts','contacts '); ?>
							<span class="divider">&nbsp;</span>
                       </li>
               ...
               <div class="span12">
                  ...
                  <div class="widget">
                     <div class="widget-title">
                        <h4><i class="icon-file"></i> Reply message</h4>
                        <span class="tools">
				...
				if($success!="") {
						...
						<?php
							...
							echo form_open('adminsettings/reply_contact',$attribute);
						?>
						 ...
						 <input type="hidden" name="rid" value="<?php echo $contacts->id; ?>">
						 <div class="control-group">
                              <label class="control-label">User Id</label>
                              <div class="controls">
                                <input type="text" class="span6 " name="mail" id="terms_conditions" value="<?php echo $contacts->email; ?>">
                              </div>
                           </div> 
						  <div class="control-group">
                              <label class="control-label">Reply Message</label>
                              <div class="controls">
                                <textarea class="span6" name="reply" id="reply" ></textarea>
                              </div>
                           </div>                           
                           ...
                           <div class="form-actions">
                              <input type="submit" name="send_mail" value="Send" class="btn btn-success">
                           </div>
						   <?php echo form_close(); ?>
                        <!--</form>-->
                        <!-- END FORM-->
