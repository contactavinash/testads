...
<head>
  ...
  <title>Rewards settings | <?php echo $admin_details->site_name; ?> Admin</title>
               ...
               <div class="span12">
                  ...
                  <h3 class="page-title">
                   ...
                   <ul class="breadcrumb">
                       ...
                       <li>
							<?php echo anchor('adminsettings/rewards_settings','Rewards settings'); ?>
							<span class="divider">&nbsp;</span>
                       </li>
					   <li>
							Rewards settings Details<span class="divider-last">&nbsp;</span>
                       </li>
                   </ul>
               </div>
            </div>
               ...
               <div class="span12">
                  ...
                  <div class="widget">
                     <div class="widget-title">
                        <h4><i class="icon-file"></i> Rewards settings</h4>
                        <span class="tools">
				...
				if($success!="") {
						...
						<?php
							...
							echo form_open('adminsettings/updaterewards_settings',$attribute);
						?>
                           <div class="control-group">
                              <label class="control-label">1 <?php echo $admin_details->coin_code;?> Coin</label> 
                              <div class="controls">
                              = <?php echo DEFAULT_CURRENCY;?>&nbsp;<input type="text" class="span5" name="cob_coins" id="cob_coins" value="<?php echo $cob_coins;?>" required />(Any purchase worth)
                              </div>
                           </div>
						 <input type="hidden" name="res_id" id="res_id" value="<?php echo $res_id; ?>">
						 <div class="control-group">
                              <label class="control-label">Maximun Coin Range</label>
                              <div class="controls">
                                <input type="text" class="span6 ckeditor" name="max_points" id="terms_conditions" value="<?php echo $max_points;?>">
                              </div>
                           </div> 
						  <div class="control-group">
                              <label class="control-label">Terms and conditions</label>
                              <div class="controls">
                                <textarea class="span6 ckeditor" name="terms_conditions" id="terms_conditions" ><?php echo $terms_conditions;?></textarea>
                              </div>
                           </div>                           
