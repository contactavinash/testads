            ...
            <div class="row-fluid">
               <div class="span12">
                  ...
                  <h3 class="page-title">
                   ...
                   <a class="btn btn-success" href="<?php echo base_url();?>adminsettings/download_coupons/expired">Download Expired Coupons</a> &nbsp;</span>
							...
							?>
                                <tr class="odd gradeX">
                                  <!--  <td><center><?php echo $k; ?></center></td>-->
                                    ...
                                    <td><center><?php echo DEFAULT_CURRENCY_CODE;?><?php echo " ".$coupon->amount; ?></center></td> 
