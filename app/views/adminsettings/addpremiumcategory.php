...
<head>
  ...
  <title>Premium Category | <?php echo $admin_details->site_name; ?> Admin</title>
               ...
               <div class="span12">
				...
				if($success!="") {
						...
						<?php
							...
							echo form_open('adminsettings/updatepremiumcategory',$attribute);
						?>
						<div class="control-group">
                              <label class="control-label">Category Name <span class="required_field">*</span></label>
                              <div class="controls">
                                <input type="text" class="span6" name="category_name" id="category_name" value="<?php echo $category_name; ?>" required />
                              </div>
                           </div>	 
