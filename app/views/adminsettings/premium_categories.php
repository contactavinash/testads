...
<head>
  ...
  <title>Premium Categories | <?php echo $admin_details->site_name; ?> Admin</title>
               ...
               <div class="span12">
                  ...
                  Premium Categories
                   ...
                   <ul class="breadcrumb">
                       ...
                       <li><?php echo anchor('adminsettings/premium_categories','Premium Categories'); ?>
                ...
                <div class="span12">
                    ...
                    <div class="widget">
                        <div class="widget-title">
                            <h4><i class="icon-reorder"></i>Premium Categories</h4>
                            <span class="tools">
                         ...
                         <form id="form2" action="" method="post" name="form2">
							...
							?>
                                <tr class="odd gradeX">
                                    ...
                                    <!-- 
									 <td align="center" style="text-align:center"><?php echo anchor('adminsettings/premium_sub_categories/'.$category_id,'<button class="btn btn-success">Sub Categories</button>'); ?> </td> 
									  --> 
                                        <?php
									...
									<!--<td>
										...
										<center>
										  <?php if($category->sort_order > 1){ 
											...
											echo anchor('adminsettings/change_premium_cate_order/up/'.$category->sort_order."/".$category->category_id,'<i class="icon-arrow-up"></i>',$up_attr);
										  } ?>
												&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										 <?php if($category->sort_order!=$max_order){

											$up_attr = array('title'=>'Move Down');
											echo anchor('adminsettings/change_premium_cate_order/down/'.$category->sort_order."/".$category->category_id,'<i class="icon-arrow-down"></i>',$up_attr);
											} ?>	
											</center>
									</td>-->
									...
									<?php echo anchor('adminsettings/editpremiumcategory/'.$category->category_id,'<i class="icon-pencil"></i>'); ?>
									</td>
									...
									echo anchor('adminsettings/delete_premium_category/'.$category->category_id,'<i class="icon-trash"></i>',$confirm); ?>
									</td>
                                </tr>
								<?php $s++;} } else { ?>
								<tr><td colspan="5">
