...
<head>
  ...
  <title>Email Template | <?php echo $admin_details->site_name; ?> Admin</title>
               ...
               <div class="span12">
                  ...
                  <h3 class="page-title">
                   ...
                   <ul class="breadcrumb">
                       ...
                       <li>
							<?php echo anchor('adminsettings/faqs','Email Template'); ?>
							<span class="divider">&nbsp;</span>
                       </li>
					   <li>
							Email Template <span class="divider-last">&nbsp;</span>
                       </li>
                   </ul>
               </div>
            </div>
               ...
               <div class="span12">
                  ...
                  <div class="widget">
                     <div class="widget-title">
                        <h4><i class="icon-file"></i> Email Template</h4>
                        <span class="tools">
					...
					<?php
						...
						<?php
							...
							echo form_open('adminsettings/update_email_template',$attribute);
						?>
						   <div class="control-group">
                              <label class="control-label">Subject <span class="required_field">*</span></label>
                              <div class="controls">
                                <input type="text" class="span6" name="email_subject" id="email_subject" value="<?php echo $email_subject; ?>" required />
                              </div>
                           </div>
						   ...
						   <div class="control-group">
                              <label class="control-label">Message <span class="required_field">*</span></label>
                              <div class="controls">
                                <textarea class="span6 ckeditor" name="email_template" id="email_template" ><?php echo $email_template; ?></textarea>
                              </div>
                           </div>
