               ...
               <div class="span12">
                  ...
                  <h3 class="page-title">
                   ...
                   <ul class="breadcrumb">
                       ...
                       <li>
							<?php echo anchor('adminsettings/rewards_faq','Rewards FAQ'); ?>
							<span class="divider">&nbsp;</span>
                       </li>
					   <li>
							Rewards FAQ Details<span class="divider-last">&nbsp;</span>
                       </li>
                   </ul>
               ...
               <div class="span12">
                  ...
                  <div class="widget">
                     <div class="widget-title">
                        <h4><i class="icon-file"></i>Rewards FAQ</h4>
                        <span class="tools">
					...
					<?php
						...
						<?php
							...
							echo form_open('adminsettings/addrewardsfaqs',$attribute);
						?>
				...
				if($success!="") {
						...
						<?php
							...
							echo form_open('adminsettings/updaterewardsfaq',$attribute);
						?>
                           <div class="control-group">
                              <label class="control-label">FAQ Question</label>
                              <div class="controls">
