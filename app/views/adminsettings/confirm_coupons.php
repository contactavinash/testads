...
<head>
  ...
  <title>Confirmed Cashback | <?php echo $admin_details->site_name; ?> Admin</title>
               ...
               <div class="span12">
                  ...
                  <h3 class="page-title">
                   ...
                   <ul class="breadcrumb">
                       ...
                       <li><?php echo anchor('adminsettings/confirm_coupon','Confirmed Cashback'); ?>
                ...
                <div class="span12">
                    ...
                    <div class="widget">
                        <div class="widget-title">
                            <h4><i class="icon-money"></i> Confirmed Cashback</h4>
                            <span class="tools">
                                <a href="javascript:;" class="icon-chevron-down"></a>
                            </span>
                        </div>
                        <div class="widget-body">
						<select name="filter" onchange="return change_days(this.value);">
						<option value="0" <?php if($change_type==0){echo 'selected';} ?>>All</option>
						<option value="1-week" <?php if($change_type=='1-week'){echo 'selected';} ?>>Last 1 week</option>
						<option value="15-days" <?php if($change_type=='15-days'){echo 'selected';} ?>>Last 15 days</option>
						<option value="1-month" <?php if($change_type=='1-month'){echo 'selected';} ?>>Last 1 month</option>
						<option value="2-months" <?php if($change_type=='2-months'){echo 'selected';} ?>>Last 2 months</option>
						</select>
						 <?php 
					...
					<?php
						...
						if($success!="") {
						 ...
						 <form id="form2" action="" method="post" name="form2">
                            <table class="table table-striped table-bordered" <?php if($cashbacks){ ?>id="sample_1"<?php } ?>>
                            <thead>
                                <tr>
                                    <th>#</th>
									...
									<th><center>Transaction Amount</center></th>
									<th><center>Reward Point</center></th>
							...
							?>
                                <tr class="odd gradeX">
								  ...
								  <td><input type="checkbox"  class="check_b" name="chkbox[<?php echo $cashback->cashback_id;?>]" /></td>	<!-- seetha-->					
									...
									?></td>
                                    <td><?php echo DEFAULT_CURRENCY." ".$cashback->cashback_amount;?></td>
									<td>
									<?php
									$amt = $cashback->transation_amount;
									if(!$cashback->transation_amount && $cashback->transation_amount==0)
									{
										$amt = 0;
									}
									echo DEFAULT_CURRENCY." ".$amt;?></td>
									<td><?php echo floor($amt/30);?></td>									
									...
									echo anchor('adminsettings/confirm_coupon/delete/'.$cashback->cashback_id,'<i class="icon-trash"></i>',$confirm); ?></center>
									</td>
                                </tr>
								<?php } } else { ?>
								<tr>
...
<script>
 ...
 {
	 window.location.href = '<?php echo base_url(); ?>adminsettings/confirm_coupon/'+value;
 }
</script>
</body>
<!-- END BODY -->
