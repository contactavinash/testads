					...
					<?php
						...
						?>
						   ...
						   <div class="control-group">
						    ...
						    <div class="control-group">
						     ...
						     <div class="control-group">
                              ...
                              <div class="controls">
								<?php echo DEFAULT_CURRENCY_CODE.' '.$user->balance; ?> 
                              </div>
                           </div>
						   
						   <div class="control-group">
                              <label class="control-label">Account Created On</label>
                              <div class="controls">
                               <label class="span6"><?php echo date('M d, Y',strtotime($user->date_added)); ?></label>
                              </div>
                           </div>
						   <hr>
						   ...
						   <div class="control-group">
                              ...
                              <div class="controls">
								<label class="span6"><?php if($user->branch_name!=""){
