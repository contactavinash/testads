...
<head>
  ...
  <title>Premium Sub Category | <?php echo $admin_details->site_name; ?> Admin</title>
         ...
         <div class="container-fluid">
            ...
            <div class="row-fluid">
               <div class="span12">
                   ...
                   <?php
				    if($action=="new"){
                          $catetory_name = $this->admin_model->get_premium_category_name($categoryid);
					}
					else
					{
						$catetory_name = $this->admin_model->get_premium_category_name($cate_id);
					}
						  ?>
                  <h3 class="page-title">
                   ...
                   <ul class="breadcrumb">
                       ...
                       <li>
							<?php echo anchor('adminsettings/premium_categories','Category'); ?>
							<span class="divider">&nbsp;</span>
                       </li>
					   <li>
               ...
               <div class="span12">
				...
				if($success!="") {
						...
						<?php
							...
							echo form_open('adminsettings/add_premium_sub_category/'.$categoryid,$attribute);
						?>
                           <div class="control-group">
                              <label class="control-label">Sub Category Name <span class="required_field">*</span></label>
                              <div class="controls">
                                <input type="text" class="span6" name="sub_category_name" id="sub_category_name" value="" required />
				...
				if($success!="") {
						...
						<?php
							...
							echo form_open('adminsettings/updatepremiumsubcategory/'.$cate_id,$attribute);
						?>
						<div class="control-group">
                              <label class="control-label">Sub Category Name <span class="required_field">*</span></label>
                              <div class="controls">
