...
<head>
  ...
  <title>Rewards | <?php echo $admin_details->site_name; ?> Admin</title>
               ...
               <div class="span12">
                  ...
                  <h3 class="page-title">
                   ...
                   <ul class="breadcrumb">
                       ...
                       <li>
							<?php echo anchor('adminsettings/rewards','Rewards'); ?>
							<span class="divider">&nbsp;</span>
                       </li>
					   <li>
							Rewards Details<span class="divider-last">&nbsp;</span>
                       </li>
                   </ul>
               </div>
            </div>
               ...
               <div class="span12">
                  ...
                  <div class="widget">
                     <div class="widget-title">
                        <h4><i class="icon-file"></i> Rewards</h4>
                        <span class="tools">
				...
				if($success!="") {
						...
						<?php
							...
							echo form_open('adminsettings/addrewards',$attribute);
						?>
							<div class="control-group">
                              <label class="control-label">COB Coins </label>
                              <div class="controls">
                              <input type="text" class="span6" name="cob_coins" id="cob_coins" value="<?php ?>" required />
                              </div>
							</div>
							<div class="control-group">
                              <label class="control-label">Rewards Title </label>
                              <div class="controls">
                               <input type="text" class="span6" name="rewards_title" id="rewards_title" value="<?php ?>" required />
                              </div>
							</div>
							<div class="control-group">
                              <label class="control-label">Rewards Image <span class="required_field">*</span></label>
                              <div class="controls">
								<span>Note: Rewards Image should be in (60 * 100) in size</span><br><!--seetha-->
                                <input type="file" class="span6" required name="rewards_image" id="rewards_image" />
                              </div>
                           </div>
                          
						  <div class="control-group">
                              <label class="control-label">Rewards Status</label>
                              <div class="controls">
                              <select name="rewards_status" required>
				...
				if($success!="") {
						...
						<?php
							...
							echo form_open('adminsettings/updaterewards',$attribute);
						?>
                           <div class="control-group">
                              <label class="control-label">COB Coins</label>
                              <div class="controls">
                                <input type="text" class="span6" name="cob_coins" id="cob_coins" value="<?php echo $cob_coins; ?>" required />
                              </div>
                           </div>
						   
						   <input type="hidden" name="rewards_id" id="rewards_id" value="<?php echo $rewards_id; ?>">
						   
						   <div class="control-group">
                              <label class="control-label">Rewards Title </label>
                              <div class="controls">
                               <input type="text" class="span6" name="rewards_title" id="rewards_title" value="<?php echo $rewards_title; ?>" required />
                              </div>
							</div>
							<div class="control-group cat_image">
                              <label class="control-label">Rewards Image <span class="required_field">*</span></label>
                              <div class="controls">
                                <input type="file" class="span6" name="rewards_image" id="rewards_image" /><br>
								<span>Note: Rewards Image should be in (60 * 100) in size</span><br>
                                <?php
								//if($rewards_image)
								//{
								?>
								<img src="<?php echo base_url(); ?>uploads/rewards/<?php echo $rewards_image; ?>" width="150">
                                <?php
							//	}
								?>
								<p id="display_error_img"></p>
								<input type="hidden" name="hidden_rewards_image" id="hidden_rewards_image"  value="<?php echo $rewards_image; ?>">
                              </div>
                           </div>
						   ...
						   <div class="control-group">
                              ...
                              <div class="controls">
                              <select name="rewards_status" required>
								  <option value="0" <?php if($rewards_status=='0'){ echo 'selected="selected"'; } ?>>De active</option>
								  <option value="1" <?php if($rewards_status=='1'){ echo 'selected="selected"'; } ?>>Active</option>
							  </select>
                              </div>
                           </div>
