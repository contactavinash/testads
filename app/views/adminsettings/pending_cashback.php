...
<head>
  ...
  <title>Pending Cashback | <?php echo $admin_details->site_name; ?> Admin</title>
                ...
                <div class="span12">
                    ...
                    <div class="widget">
                        <div class="widget-title">
                            <h4><i class="icon-money"></i> Pending Cashback</h4>
                            <span class="tools">
							...
							?>
                                <tr class="odd gradeX">
								  ...
								  <td><input type="checkbox"  class="check_b" name="chkbox[<?php echo $cashback->cashback_id;?>]" /></td>	<!-- seetha-->					
									...
									<td><center>
									<?php	
									$confirm = array("class"=>"confirm-dialog", "onclick"=>"return confirmDelete('Do you want to approve this cashback?');", "title"=>"Approve this cashback");
									echo anchor('adminsettings/pending_cashback/withdraw_payu/'.$cashback->cashback_id,'<button class="btn btn-success" type="button">Approve</button>',$confirm); ?>
									</center></td>
									...
									echo anchor('adminsettings/pending_cashback/delete/'.$cashback->cashback_id,'<i class="icon-trash"></i>',$confirm); ?></center>
									</td>
                                </tr>
								<?php } } else { ?>
								<tr>
...
<script>
 ...
 {
	 window.location.href = '<?php echo base_url(); ?>adminsettings/pending_cashback/'+value;
 }
</script>
</body>
<!-- END BODY -->
