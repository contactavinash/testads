                  ...
                  <div class="widget">
					...
					<?php
						...
						?>
							...
							<!--<br/><small class="desc">eg : amazon</small>-->
						  </div>
						</div>
						   <div class="control-group">
						    ...
						    <div class="control-group">
                              ...
                              <div class="controls">
								<input type="text" name="expiry_date" id="expiry_date" required class="span6 date-picker sp1" onblur="return check_date();">
                              </div>
                           </div>
                          ...
                          <!--  <div class="control-group">
                              <label class="control-label">Cashback Description 
                               <span class="required_field">*</span> 
                              </label>
                              <div class="controls">
								<textarea name="cashback_description" required id="cashback_description" class="span6"></textarea>
						   ...
						   <div class="control-group">
                              ...
                              <div class="controls">
                              <input type="url" name="offer_page" id="offer_page"  class="span6" rows="5" required>
					...
					<?php
						...
						<!--<input type="text" name="offer_name" id="offer_name" required class="span6">-->
						   ...
						   <div class="control-group">
                              <label class="control-label">Expires On <span class="required_field">*</span></label>
                              <div class="controls">
								<input type="text" name="expiry_date" id="expiry_date"  required class="span6 date-picker sp1" value="<?php echo $expiry_date; ?>" onblur="return check_date();">
                              </div>
                           </div>
						...
						<!--   <div class="control-group">
                           ...
                           <!--  <div class="control-group">
                              ...
                              <div class="controls">
								<textarea name="cashback_description" required id="cashback_description" class="span6"><?php echo $cashback_description; ?></textarea>
                                <span class="small">Default : Get additional upto [Retailler Cashback] Cashback from <?php echo $admin_details->site_name; ?></span>
                              </div>
                           </div> -->
                           
                          
						   <div class="control-group" id="hidesh" style="display:<?php if($type=='Coupon'){echo 'block';}else{echo 'none';}?>">
						   ...
						   <div class="control-group">
                              <label class="control-label">URL <span class="required_field">*</span></label>
                              <div class="controls">
                              <input type="url" name="offer_page" id="offer_page" class="span6" value="<?php echo $offer_page; ?>" rows="5" required>
						  ...
						  <!--  <div class="control-group">
                           ...
                           <div class="form-actions">
                              <input type="submit" name="save" value="Save Changes" class="btn btn-success" id="valid">
                           </div>
	  ...
	  $('#valid').click(function()
{
 ...
 $("#addcoupon").validate({
    ...
    messages: {
        offer_name: "choose offer name",
        category_name: "choose category",
		//coupon_options:'choose option',
