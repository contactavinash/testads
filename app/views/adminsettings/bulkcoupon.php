               ...
               <div class="span12">
                  ...
                  <div class="widget">
					...
					<?php
                        ...
                        <!-- BEGIN FORM-->
						<?php
							$attribute = array('role'=>'form','name'=>'bulkcoupon','method'=>'post','class'=>'form-horizontal','enctype'=>'multipart/form-data','onSubmit'=>'return ValidateFileUpload();'); 
						...
						?>
						 ...
						 <!--  <div class="control-group">
						   ...
						   <div class="control-group">
                              ...
                              <div class="controls">
                                <input type="file" name="bulkcoupon" id="bulkcoupon"><span style="margin-left: 10px;"><a style="color: rgb(135, 206, 4);" href="<?php echo base_url(); ?>uploads/csv_examples/coupons.csv"><img align="absmiddle" src="<?php echo base_url(); ?>front/images/csv.png"> example.csv</a></span>
								<br>
