                ...
                <div class="span12">
					...
					<?php
                     ...
                     <div class="row-fluid">
                        ...
                        <input data-path=".titles" type="text" value="" placeholder="Filter by Store" data-control-type="textbox" data-control-name="title-filter" data-control-action="filter" class="form-control" /></div>
...
<p> <div class="alert alert-danger" align="center"> No products found!!!</div></p>
                            ...
                            <table class="table table-striped table-bordered demo-tbl" id="sample_112">
                            <thead> 
                                <tr>
                                    <th>#</th>
							...
							?>
                                <tr class="odd gradeX tbl-item">
                                   ...
                                   <!-- <td><?php echo $coupon->promo_id; ?></td>
                                    ...
                                    <td><p class="titles "><?php echo $coupon->offer_name; ?></p></td>
