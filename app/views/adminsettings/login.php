              ...
              <div class="controls">
                  <div class="input-prepend">
                    <?php	$a = rand(100,999);
							...
							echo $cap['image'];
					?>
					  <input id="code" type="text" name="code" required autocomplete="off" placeholder="CAPTCHA code" style="width:159px; padding:7px;" />
                  </div>
				  <div><font color="#CC0000"><?php echo form_error('code'); ?></font></div>
				   <div class="mtop10">
                      <!--<div class="block-hint pull-left small">
                          <input type="checkbox" id=""> Remember Me
                      </div>-->
                      <div class="block-hint pull-right">
                          <a href="<?php echo base_url(); ?>adminsettings/forgetpassword" class="" id="forget-password" style="color: #fff;">Forgot Password?</a>
                      </div>
                  </div>
