...
<head>
  ...
  <title>Offline Store Details | <?php echo $admin_details->site_name; ?> Admin</title>
      ...
      <div id="main-content">
         ...
         <div class="container-fluid">
            ...
            <div class="row-fluid">
             ...
             <li>
              <?php echo anchor('adminsettings/off_affiliates','Offline Stores'); ?>
              <span class="divider">&nbsp;</span>
                       </li>
                       <!-- <li>
               ...
               <div class="span12">
                  ...
                  <div class="widget">
                     <div class="widget-title">
                        <h4><i class="icon-cog"></i>Offline Stores Details</h4>
                        <span class="tools">
          ...
          <?php
            ...
            // foreach($res as $rr) {
              ...
              echo form_open('adminsettings/update_offline/'.$rr->store_id,$attribute);
            ?>
                           <div class="control-group">
                              <label class="control-label">Store Name</label>
                              <div class="controls">
                <label class="span6"><?php echo $rr->store_name; ?></label>
                              </div>
                           </div>
               ...
               <div class="control-group">
                              ...
                              <div class="controls">
                <label class="span6">
                <img src="<?php echo base_url();?>uploads/offline_stores/<?php echo $rr->store_logo; ?>" width="110" height="35" />
                </label>
                              </div>
                           </div>
                <?php 
                // echo $rr->store_id;
                $get_address = $this->admin_model->get_Address($rr->store_id);
                       foreach($get_address as $get){ 
                 ?>
                             <div class="control-group">
                              <label class="control-label">Store Address</label>
                              <div class="controls">
                <label class="span6"><?php echo $get->address; ?></label>
                              </div>
                           </div>
                             <div class="control-group">
                              <label class="control-label">Latitude</label>
                              <div class="controls">
                <label class="span6"><?php echo $get->latitude; ?></label>
                              </div>
                           </div>
                            ...
                            <div class="control-group">
                              ...
                              <div class="controls">
                <label class="span6"><?php echo $get->longtitude; ?></label>
                              </div>
                           </div>
                          <?php } ?>
