               ...
               <div class="span12">
                  ...
                  <h3 class="page-title">
                   ...
                   <ul class="breadcrumb">
                       ...
                       <li>
							<?php echo anchor('adminsettings/blog','BLOG'); ?>
							<span class="divider">&nbsp;</span>
                       </li>
					   <li>
							BLOG Details<span class="divider-last">&nbsp;</span>
                       </li>
                   </ul>
               </div>
            </div>
               ...
               <div class="span12">
                  ...
                  <div class="widget">
                     <div class="widget-title">
                        <h4><i class="icon-file"></i> BLOG</h4>
                        <span class="tools">
				...
				if($success!="") {
						...
						<?php
							...
							echo form_open('adminsettings/addblog',$attribute);
						?>
                           <div class="control-group">
                              <label class="control-label">Blog Title</label>
                              <div class="controls">
                                <input type="text" class="span6" name="page_title" id="page_title" value="<?php ?>" required />
                              </div>
                           </div>
                           ...
                           <div class="control-group">
                             ...
                             <div class="control-group">
                              <label class="control-label">Blog Image <span class="required_field">*</span></label>
                              <div class="controls">
				...
				if($success!="") {
                        ...
                        <!--<form action="#" class="form-horizontal">-->
						<?php
							$attribute = array('role'=>'form','name'=>'cms','method'=>'post','id'=>'update_form','enctype'=>'multipart/form-data','class'=>'form-horizontal'); 
							echo form_open('adminsettings/updateblog',$attribute);
						?>
                           <div class="control-group">
                              <label class="control-label">Blog Title</label>
                              <div class="controls">
                           ...
                           <div class="control-group">
                              ...
                              <div class="controls">
                              <input type="file" name="affiliate_logo" id="affiliate_logo"/><br>
								<img src="<?php echo base_url();?>uploads/blog/<?php echo $affiliate_logo; ?>" width="180" height="35">
                              </div>
                           </div>
