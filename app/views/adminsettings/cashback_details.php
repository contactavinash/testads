...
<head>
  ...
  <title>Cashback Details - <?php echo $store_details->affiliate_name?>| <?php echo $admin_details->site_name; ?> Admin</title>
         ...
         <div class="container-fluid">
            ...
            <div class="row-fluid">
               <div class="span12">
                  ...
                  <h3 class="page-title">
                    Category Cashback - <?php echo $store_details->affiliate_name?>
                  </h3>
                   <ul class="breadcrumb">
                       <li>
                   ...
                   <a href="<?php echo base_url();?>adminsettings/affiliates" class="btn btn-success">View all Retailers</a></span>
                ...
                <div class="span12">
                    ...
                    <div class="widget">
                        <div class="widget-title">
                            <h4><i class="icon-reorder"></i> Category Cashback - <?php echo $store_details->affiliate_name?></h4>
                            <span class="tools">
                ...
                <form id="form2" action="" method="post" name="form2">
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th><center>Cashback Details</center></th>
                                    <th><center>Cashback Type</center></th>
                                    <th><center>Cashback</center></th>
                                    <th><center>Status</center></th>
                                    <th class="hidden-phone"><center>Edit</center></th>
							...
							$k=0;
							if($cashbacks){
							foreach($cashbacks as $cashback_details){
							...
							?>
                                <tr class="odd gradeX">
                                    <td><?php echo $k; ?></td>
									 <td><input type="checkbox"  class="check_b" name="chkbox[<?php echo $cashback_details->cbid;?>]" /></td>
                                    <td><center><?php echo $cashback_details->cashback_details;?></center></td>
									...
									<td><center>
											<?php echo $cashback_details->status;?>
										</center>
									</td>
                                    <td class="center hidden-phone"><center>
                                    <a href="<?php echo base_url();?>adminsettings/editstore_cashback/<?php echo $store_id;?>/<?php echo $cashback_details->cbid;?>" class="btn btn-success"><i class="icon-pencil"></i></a>
                                    </center>
                                    </td>
                                    <td>
                                    <center>
									...
									$confirm = array("class"=>"confirm-dialog","onclick"=>"return confirmDelete('Do you want to delete this Cashback details?');");
									echo anchor('adminsettings/deletecashbackdetails/'.$store_id.'/'.$cashback_details->cbid,'<i class="icon-trash"></i>',$confirm); ?></center>
									</td>
                                </tr>
								<?php } } else { ?>
								<tr>
								<td colspan="5">No cashback Found.</td>
								</tr>
								<?php } ?>
                            </tbody>
                        </table>
