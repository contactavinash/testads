...
<head>
  ...
  <title>Upload Coupon | <?php echo $admin_details->site_name; ?> Admin</title>
               ...
               <div class="span12">
                  ...
                  <h3 class="page-title">
                   ...
                   <ul class="breadcrumb">
                       ...
                       <li>
							<?php echo anchor('adminsettings/bulkcoupon','Upload Coupon'); ?>
               ...
               <div class="span12">
                  ...
                  <div class="widget">
                     <div class="widget-title">
                        <h4><i class="icon-file"></i> Upload Coupon</h4>
                        <span class="tools">
					...
					<?php
                        ...
                        <!-- BEGIN FORM-->
						<?php
							$attribute = array('role'=>'form','name'=>'bulkcoupon','method'=>'post','id'=>'bulkcoupon','class'=>'form-horizontal','enctype'=>'multipart/form-data','onSubmit'=>'return ValidateFileUpload();'); 
							echo form_open('adminsettings/bulkcoupon',$attribute);
						?>

						   <div class="control-group">
                              <label class="control-label">Tracking URL Parameter </label>
                              <div class="controls">
                                <!--<select name="coupon_type">
									<option value="VCommission">VCommission</option>
									<option value="Icubewire">Icubewire</option>
								</select>-->
                                <input type="text" name="tracing_param" id="tracing_param" required > eg: aff_id (This id only used to track the user). Affilate Provider gives this extra parameter. 
                              </div>
                           </div>
						   
						   <div class="control-group">
                              <label class="control-label">Upload File <span class="required_field">*</span></label>
                              <div class="controls">
                                <input type="file" name="bulkcoupon" required id="bulkcoupon"><br><br>
								  <p>Supported File Formats : .csv , .xls and .xlsx</p>
                              </div>
                           </div>
  ...
  <?php $this->load->view('adminsettings/footer'); ?>
   ...
   <script>
	...
	function ValidateFileUpload() {
        var fuData = document.getElementById('bulkcoupon');
...
//To check if user upload any file
        if (FileUploadPath == '') {
			...
			//The file uploaded is an allowed type file
			...
			// The file upload is NOT an image
                ...
                alert("Only allowed file types are csv, xls and xlsx.");
				$('#bulkcoupon').val("");
				return false;
            }
        }
