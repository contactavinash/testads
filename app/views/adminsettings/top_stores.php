                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <ol class="breadcrumb">
                                ...
                                <li class=""><a href="<?php echo base_url();?>cashback/stores_list">Top Store Offers</a></li>
...
$kt = 1;
                ...
                <li class="dynamiccls" <?php echo $extracss." "; 
										...
										?> 
										<?php //echo anchor('cashback/stores_list/'.$view->category_url,'<i class="fa fa-arrow-circle-right"></i>'.$view->category_name); ?></li>
                <?php 
...
?>
          ...
          <section class="main-content col-md-9">
            <div class="store-title">
              <h3 class="mar-no mar-bot20">Top Stores from <?php echo $category_details->category_name;?></h3>
            </div>
            <?php
