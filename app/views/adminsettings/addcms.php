               ...
               <div class="span12">
                  ...
                  <h3 class="page-title">
                   ...
                   <ul class="breadcrumb">
                       ...
                       <li>
							<?php echo anchor('adminsettings/cms','CMS'); ?>
							<span class="divider">&nbsp;</span>
                       </li>
					   <li>
							CMS Details<span class="divider-last">&nbsp;</span>
                       </li>
                   </ul>
               </div>
            </div>
            ...
            <div class="row-fluid">
               <div class="span12">
				...
				if($success!="") {
                        ...
                        <!--<form action="#" class="form-horizontal">-->
						<?php
							$attribute = array('role'=>'form','name'=>'cms','method'=>'post','id'=>'update_form','class'=>'form-horizontal'); 
