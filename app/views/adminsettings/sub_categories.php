...
<head>
  ...
  <title>Sub Categories | <?php echo $admin_details->site_name; ?> Admin</title>
         ...
         <div class="container-fluid">
            ...
            <div class="row-fluid">
               <div class="span12">
                  ...
                  <?php
                          $catetory_name = $this->admin_model->get_category_name($category_id);
						  ?>
                  <h3 class="page-title">
                   ...
                   <ul class="breadcrumb">
                       ...
                       <li><?php echo anchor('adminsettings/sub_categories/'.$category_id,'Sub Categories'); ?>
							<span class="divider-last">&nbsp;</span>
					   </li>
                   </ul>
                  <!-- END PAGE TITLE & BREADCRUMB-->
                     <!-- Start Sub Category-->
                 <?php echo anchor('adminsettings/add_sub_category/'.$category_id,'<button style="float:right" class="btn btn-success">Add Sub Category</button>'); ?> 
                      <!-- End Sub Category-->
               </div>
            </div>
            <!-- END PAGE HEADER-->
                ...
                <div class="span12">
					...
					<?php
						...
						?>  <form id="form2" action="" method="post" name="form2">
							...
							?>
                                <tr class="odd gradeX">
                                    ...
                                    <td><input type="checkbox"  class="check_b" name="chkbox[<?php echo $category->sun_category_id;?>]" /></td>
									...
									?>
                                     <td><input class="textbox" type="text" size="4" value="<?php echo $sort_order;?>" name="sort_arr[<?php echo $category->sun_category_id;?>]"></td>
									<td>
                                   <?php $cateid =  $category->cate_id;
								   $catetory_name = $this->admin_model->get_category_name($cateid);
								   echo $catetory_name;
								    ?>
									...
									<?php echo anchor('adminsettings/editsubcategory/'.$category->sun_category_id,'<i class="icon-pencil"></i>'); ?>
									</td>
                                    <td class="center hidden-phone">
									<?php
									$confirm = array("class"=>"confirm-dialog","onclick"=>"return confirmDelete('Do you want to delete this category detail?');");		
									echo anchor('adminsettings/deletesubcategory/'.$category->sun_category_id.'/'.$cateid ,'<i class="icon-trash"></i>',$confirm); ?>
									</td>
                                </tr>
								<?php } } else { ?>
								<tr><td colspan="5">
                       ...
                       <input type="hidden" name="hidd" value="hidd">
                        <input id="GoUpdate" class="btn btn-warning" type="submit" value="Update Sub Categories" name="GoUpdate">
                        </form>
                        <?php
						}
						else
