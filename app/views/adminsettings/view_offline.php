...
<head>
   ...
   <?php $admin_details = $this->admin_model->get_admindetails(); ?>
	<title>Pending Offline Users | <?php echo $admin_details->site_name; ?> Admin</title>
               ...
               <div class="span12">
                  ...
                  <h3 class="page-title">
                   ...
                   <ul class="breadcrumb">
                       ...
                       <li><?php echo anchor('adminsettings/pending_offline','Pending Offline Users'); ?>
                ...
                <div class="span12">
                    ...
                    <div class="widget">
                        <div class="widget-title">
                            <h4><i class="icon-money"></i> Pending Offline Users</h4>
                            <span class="tools">
            ...
            echo '';
              ...
              ?>
                    ...
                    ?>
                                      ...
                                      <td><center><?php
									  if($coupon->admin_status=='0')
									  {
										  ?>
                                          <span class="btn btn-warning"><?php echo 'Pending';?></span>
                                          <?php
										  }
