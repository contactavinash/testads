...
<head>
  ...
  <title>Upload Retailers | <?php echo $admin_details->site_name; ?> Admin</title>
               ...
               <div class="span12">
                  ...
                  <h3 class="page-title">
                   ...
                   <ul class="breadcrumb">
                       ...
                       <li>
							<?php echo anchor('adminsettings/bulk_store','Upload Retailers'); ?>
							<span class="divider-last">&nbsp;</span>
                       </li>
                   </ul>
                   <span style="float:right">
                   <a href="<?php echo base_url();?>adminsettings/affiliates" class="btn btn-success">View Retailer</a> &nbsp;
                   <a href="<?php echo base_url();?>adminsettings/addaffiliate" class="btn btn-success">Add Retailers</a></span>
               </div>
            </div>
            <!-- END PAGE HEADER-->
            <!-- BEGIN PAGE CONTENT-->
               ...
               <div class="span12">
                  ...
                  <div class="widget">
                     <div class="widget-title">
                        <h4><i class="icon-file"></i> Upload Retailers</h4>
                        <span class="tools">
					...
					<?php
                        ...
                        <!-- BEGIN FORM-->
						<?php
							$attribute = array('role'=>'form','name'=>'bulk_store','method'=>'post','class'=>'form-horizontal','enctype'=>'multipart/form-data','onSubmit'=>'return ValidateFileUpload();'); 
							echo form_open('adminsettings/bulk_store',$attribute);
						?>
						 ...
						 <!--  <div class="control-group">
						   ...
						   <div class="control-group">
                              ...
                              <div class="controls">
                                <input type="file" name="bulkcoupon" id="bulkcoupon"><span style="margin-left: 10px;"><a style="color: rgb(135, 206, 4);" href="<?php echo base_url(); ?>uploads/csv_examples/retailers.csv"><img align="absmiddle" src="<?php echo base_url(); ?>front/images/csv.png"> example.csv</a></span>
								<br>
