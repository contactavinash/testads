...
<head>
   ...
   <?php $admin_details = $this->admin_model->get_admindetails(); ?>
	<title>Confirm Referral | <?php echo $admin_details->site_name; ?> Admin</title>
               ...
               <div class="span12">
                  ...
                  <h3 class="page-title">
                   ...
                   <ul class="breadcrumb">
                       ...
                       <li><?php echo anchor('adminsettings/confirm_referral','Confirm Referral'); ?>
                ...
                <div class="span12">
                    ...
                    <div class="widget">
                        <div class="widget-title">
                            <h4><i class="icon-money"></i> Confirm Referral</h4>
                            <span class="tools">
								...
								<?php
                                    ...
                                    <td><?php echo $refer->referral_email; ?></td>
                                     <td><?php echo $refer->date_added; ?></td>
									  ...
									  {
										  ?>
                                          <span class="label label-green"><?php echo 'Confirmed';?></span>
                                          <?php
										  }
