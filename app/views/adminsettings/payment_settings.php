               ...
               <div class="span12">
                  ...
                  <h3 class="page-title">
                   ...
                   <ul class="breadcrumb">
                       ...
                       <li>
							<?php echo anchor('adminsettings/payment_settings','Payment Settings'); ?>
               ...
               <div class="span12">
                  ...
                  <div class="widget">
                     <div class="widget-title">
                        <h4><i class="icon-cog"></i>  Admin Payment Settings</h4>
                        <span class="tools">
				...
				if($success!="") {
						...
						<?php
							...
							echo form_open('adminsettings/payment_settings',$attribute);
						?>
                        <h5><b>PayUmoney Payment Settings</b></h5>
                        	
                             <div class="control-group">
                              <label class="control-label">Merchant Key <span class="required_field">*</span></label>
                              <div class="controls">
                                <input type="text" class="span6" name="merchant_key" id="merchant_key" value="<?php echo $merchant_key; ?>" required />
                              </div>
                           </div>
						   
							
						    <div class="control-group">
                              <label class="control-label">Merchant Salt <span class="required_field">*</span></label>
                              <div class="controls">
                                <input type="text" class="span6" name="merchant_salt" id="merchant_salt" value="<?php echo $merchant_salt; ?>" required />
                              </div>
                           </div>
                           
                            <div class="control-group">
                              <label class="control-label">Merchant Id <span class="required_field">*</span></label>
                              <div class="controls">
                                <input type="text" class="span6" name="merchant_id" id="merchant_id" value="<?php echo $merchant_id; ?>" required />
                              </div>
                           </div>
                           
                            <div class="control-group">
                              <label class="control-label">Payment Mode <span class="required_field">*</span></label>
                              <div class="controls">                               
                               <select name="payment_mode" class="span6">
									<option value="1" <?php if($payment_mode=='1'){ echo 'selected="selected"'; }?>>Live Mode</option>
									<option value="0" <?php if($payment_mode=='0'){ echo 'selected="selected"'; }?>>Test Mode</option>
								</select>
                              </div>
                           </div>
