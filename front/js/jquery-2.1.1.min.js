...
! function() {
    $.fn.stepsForm = function(t) {
        var e = {
                ...
                sendbtntext: "<i class='fa fa-long-arrow-right'></i>",
        ...
        return this.each(function() {
            ...
            function n() {
                f.find(".sf-steps-content>div").removeClass("sf-active"), f.find(".sf-steps-form>.sf-content").css({
                    display: "none"
                }), f.find(".sf-steps-form>ul").eq(t.active).fadeIn(), f.find(".sf-steps-content>div").eq(t.active).addClass("sf-active"), f.find("#sf-next").html(t.active == c - 1 ? t.sendbtntext : l), f.find("#sf-prev").css(0 == t.active ? {
                    display: "none"
                } : {
                    display: "inline-block"
                })
