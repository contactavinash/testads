    ...
    var i = {
        ...
        setWindowPostition: function(t) {
            ...
            if ("window" == n.options.zoomType || "inner" == n.options.zoomType) 1 == n.zoomLock && (1 >= n.widthRatio && (n.windowLeftPos = 0), 1 >= n.heightRatio && (n.windowTopPos = 0)), n.largeHeight < n.options.zoomWindowHeight && (n.windowTopPos = 0), n.largeWidth < n.options.zoomWindowWidth && (n.windowLeftPos = 0), n.options.easing ? (n.xp || (n.xp = 0), n.yp || (n.yp = 0), n.loop || (n.loop = setInterval(function() {
                ...
                n.scrollingLock ? (clearInterval(n.loop), n.xp = n.windowLeftPos, n.yp = n.windowTopPos, n.xp = -1 * ((t.pageX - n.nzOffset.left) * n.widthRatio - n.zoomWindow.width() / 2), n.yp = -1 * ((t.pageY - n.nzOffset.top) * n.heightRatio - n.zoomWindow.height() / 2), n.changeBgSize && (n.nzHeight > n.nzWidth ? ("lens" == n.options.zoomType && n.zoomLens.css({
                ...
                }), n.scrollingLock = !1, n.loop = !1) : (n.changeBgSize && (n.nzHeight > n.nzWidth ? ("lens" == n.options.zoomType && n.zoomLens.css({
                    "background-size": n.largeWidth / n.newvalueheight + "px " + n.largeHeight / n.newvalueheight + "px"
                }), n.zoomWindow.css({
                    "background-size": n.largeWidth / n.newvalueheight + "px " + n.largeHeight / n.newvalueheight + "px"
                })) : ("lens" != n.options.zoomType && n.zoomLens.css({
        ...
        swapAction: function(t, n) {
            ...
            if (r.options.imageCrossfade) {
                ...
                r.options.tint && "inner" != r.options.zoomType && (s = r.zoomTintImage, o = s.clone(), r.zoomTintImage.attr("src", n), r.zoomTintImage.after(o), o.stop(!0).fadeOut(r.options.imageCrossfade, function() {
                    e(this).remove()
                }), s.fadeIn(r.options.imageCrossfade), r.zoomTint.css({
            ...
            } else r.$elem.attr("src", t), r.options.tint && (r.zoomTintImage.attr("src", n), r.zoomTintImage.attr("height", r.$elem.height()), r.zoomTintImage.css({
                height: r.$elem.height()
            }), r.zoomTint.css({
                height: r.$elem.height()
